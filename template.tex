...
\cvname{P\'{o}cs G\'{e}za} % Your name
\cvjobtitle{Test Engineer} % Job title/career

\cvdate{13 July 1988} % Date of birth
\cvaddress{Cluj-Napoca, Romania} % Short address/location, use \newline if more than 1 line is required
\cvnumberphone{+40 741457975} % Phone number
\cvsite{http://en.wikipedia.org} % Personal website
\cvmail{pocsgeza@gmail.com} % Email address
...
\aboutme{Solveing problems and building things that solve problems it the main theme of my life so far. Most of the technical and social skills I have built up until the present came as side efects of projects I was building and problems I was trying to solve. } % To have no About Me section, just remove all the text and leave \aboutme{}
...
\skills{{Sitting all day in front of a computer/1},{PLC programming/4},{Engineering+Chemistry/5.5},{Craftsmanship/5},{Adaptability/4},{Troubleshooting/5.5}}
